...
class PackageEnrolLog extends Moloquent
{

    protected $collection = "erp_package_enrol_log";
    ...
    {
        return Sequence::getSequence('package_enrol_log_id');
    }
    ...
    {
        $log_id['rid'] = self::uniqueErpEnrolLogId();
     ...
     */
    public static function getPackageUsergroupImportRecords(
        $type = 'ALL',
        $start = 0,
        $limit = 10,
        ...
        return self::where('enrol_level', '=', $enrol_level)
            ->where(
                function ($query) {
     ...
     */
    public static function getPackageUsergroupImportCount(
        $type = 'ALL',
        $search = null,
        $created_date = null,
        $enrol_level = 'usergroup',
     ...
     * @return array of log records
     */
    public static function getPackageUsergroupExportRecords(
        $type = 'ALL',
        $created_date = null,
        $enrol_level = 'usergroup'
    ) {
