...
namespace App\Model\ImportLog\Entity;

use Moloquent;
use App\Model\Sequence;

class PackageLog extends Moloquent
{
    
    protected $collection = "erp_package_log";
     ...
     * @return int
     */
    public static function uniqueErpPackageLogId()
    {
        return Sequence::getSequence('package_log_id');
    }

    /** This function used to insert record
     *
     * @method getInsertErpPackageLog
     * @param  array $input
     * @return bool
     */
    public static function getInsertErpPackageLog($input)
    {
        $id = self::uniqueErpPackageLogId();
        $log_id['rid'] = $id;
     ...
     */
    public static function scopePackageSearch($query, $search = null)
    {
        if ($search != null) {
     ...
     * @return string status filter to query
     */
    public static function scopePackageFilter($query, $filter = 'ALL')
    {
     ...
     */
    public static function scopePackageAction($query, $action = 'ALL')
    {
     ...
     */
    public static function getPackageExportRecords(
        $type = 'ALL',
        $created_date = null,
        $action = 'ALL'
    ) {
     ...
     */
    public static function getPackageImportCount(
        $type = 'ALL',
        $search = null,
        $created_date = null,
        $action = 'ALL'
     ...
     * @return array of log records
     */
    public static function getPackageImportRecords(
        $type = 'ALL',
        $start = 0,
        $limit = 10,
