    ...
    */
    ...
    private function doCurl($url, $params = [], $files = [])
    {
        ...
        if ($this->config->method == self::METHOD_POST) {
            ...
            if (count($files) > 0) {
            // Code added by cerlin
                /*
					Previous code : 
						foreach($files as &$file)
							$file = "@".$file; // let curl know its a file
					This code is replaced with new code since using `"@".$file` is deprecated
					Reference : http://stackoverflow.com/questions/20972513/php-curl-the-usage-of-the-filename-api-for-file-uploading-is-deprecated
				*/
                foreach ($files as &$file) {
...
class KalturaConfiguration
{
    ...
    public $serviceUrl                  = "10.100.1.16";
    public $partnerId                   = null;
    public $format                      = 3;
    public $clientTag                   = "php5:15-02-18";
