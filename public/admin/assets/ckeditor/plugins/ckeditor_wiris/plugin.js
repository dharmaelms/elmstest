...
// Custom Editors: 
var _wrs_int_customEditors = {chemistry : {name: 'Chemistry', toolbar : 'chemistry', icon : 'chem.gif', enabled : true, confVariable : '_wrs_conf_chemEnabled', title: 'Chemistry Toolbar'},
PARCC_Grade3_5 : {name: 'PARCC_Grade3_5', toolbar : 'PARCC_Grade3_5', icon : 'formula_red.gif', enabled : false, confVariable : '_wrs_confParcc35Enabled', title: 'Grade 3-5 Toolbar'},
PARCC_Grade6_8 : {name: 'PARCC_Grade6_8', toolbar : 'PARCC_Grade6_8', icon : 'formula_green.gif', enabled : false, confVariable : '_wrs_confParcc68Enabled', title: 'Grade 6-8 Toolbar'},
PARCC_Grade9_12 : {name: 'PARCC_Grade9_12', toolbar : 'PARCC_Grade9_12', icon : 'formula_blue.gif', enabled : false, confVariable : '_wrs_confParcc912Enabled', title: 'Grade 9-12 Toolbar'},

}
var _wrs_confParcc35Enabled = true;
var _wrs_confParcc68Enabled = true;
var _wrs_confParcc912Enabled = true;
