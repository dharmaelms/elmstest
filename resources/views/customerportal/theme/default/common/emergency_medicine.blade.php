    ...
    <div class="container">
      <div class="row margin-bottom-40">
       <!--  <div class="col-md-5 col-sm-5 col-xs-12">
        ...
        <!-- <div></div>iv class="col-md-7 col-sm-7 col-xs-12 center"> -->
          <div class="margin-bottom-20"></div>
           <?php
            $slug = 'emergency';
            $StaticPage = StaticPage::getOneStaticPageforSlug($slug);
            $eContent = '';
            if(isset($StaticPage) && !empty($StaticPage))
            {
              $eContent = strip_tags($StaticPage[0]['content']);
            }
           ?>
           <center>
          <h2 class="black green-border margin-bottom-30">NBE Emergency Medicine</h2></center>
          <p class="font-15 margin-bottom-20" style="text-align: justify;">
          {{$eContent}}
            <!-- {{str_limit($eContent,$limit = 698)}}<a href="{{URL::to('emergency')}}">Read More</a> -->
          </p>
      ...
      <?php
       ...
       if(!empty($about)) {
       ?>
        <div class="col-md-5 col-sm-5 col-xs-12 pull-right margin-bottom-20 center"  id="about">
          <h2 class="margin-bottom-20 black">About Us</h2>
          <p class="font-15 margin-bottom-20" style="text-align: justify;">{{str_limit($about,$limit = 219, $end ='...')}}</p>
          <p class="center"><a href="{{URL::to('about-emergency')}}" class="btn btn-success">View More</a></p>
        </div>
        <?php } ?>
        <!-- login -->
        <div class="col-md-7 col-sm-7 col-xs-12" id="announcement-div">
          <div class="row">
             ...
             <?php
              ...
              <ul class="margin-bottom-20">
                <li class="margin-bottom-20">
                  ...
                  <!-- <p class="font-13">{{Common::getPublishOnDisplay((int)$value['schedule'])}}</p> -->
                </li>
              </ul>
              <?php if($i == 1) {break;}?>
              @endforeach
