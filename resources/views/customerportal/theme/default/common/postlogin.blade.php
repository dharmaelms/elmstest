...
?>
		<div class="row">
			...
			<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 sub-title-container">
				...
				<span class="sub-title"><a href="{{ URL::to('announcements') }}">View All</a></span>
			</div>
			@endif
		</div>
...
?>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<span style="font-size:13px;">No announcements have been published yet.</span>
			</div>
		</div>
		@endif
	</div>
	<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 custom-border-right">
		<div class="row">
			...
			<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 sub-title-container">
				<span class="l-gray">|</span>
				<span class="sub-title"><a href="{{ URL::to('user') }}">View All</a></span>
			</div>
		</div>
		<div class="title-border"></div>
			...
			<div class="col-md-12">
				<div class="row">
					<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
						<span class="activity-title">Overall quiz performance</span>
					</div>
				</div>
				<div class="row">
					@if($myRecentActivity["quiz_perfomance"]["data_flag"])
						...
						<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2" style="padding: 5px; font-weight: bold; color:  rgb(77, 139, 192);">
							{{ $myRecentActivity["quiz_perfomance"]["percentage"] }}%
						</div>
					@else
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<span style="font-size:13px;">You have not taken any quiz in recent times.</span>
						</div>
					@endif
				</div>
			</div>
		...
		<div class="row activity-container subsequent ">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="row">
					<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
						<span class="activity-title">Overall channel completion</span>
					</div>
				</div>
				<div class="row">
				...
				@else
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<span style="font-size:13px;">You are not subscribed to any channels in recent times.</span>
					</div>
				@endif
				</div>
				...
				<?php
					...
					<div style="margin-top:10px; border-top:1px solid #dddddd;margin-bottom:10px;"></div>
					<div class="row">
						<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
						  <div class="col-md-4">
						  	<div class="dashboard-header-item-title">CURRENT LEVEL</div>
    						<div class="dashboard-header-item-value">
    							<img src="/pl/image?size=small&metric_id={{$pl_score["metric"]["id"]}}&state={{$pl_score["value"]["name"]}}"></img>
    						</div>
    						<div class="dashboard-header-item-value">{{$pl_score["value"]["name"]}}</div>
    						<div class="dashboard-header-item-score">({{$pl_score["meta"]["low"]}} XP)</div>
						  </div>
						  <div class="col-md-4">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							@if(count($badges) == 0)
								<span style="font-size:13px;">You dont have any badges.</span>
							@else
		...
		<div class="row activity-container subsequent">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<span>Quiz performance can improve in <b>{{ $myRecentActivity["areas_of_improvement"]["channel_count"] }}</b> {{ ($myRecentActivity["areas_of_improvement"]["channel_count"] > 1) ? "channels" : "channel" }}</span>
					</div>
				</div>
