          ...
          <ul class="dropdown-menu dropdown-menu-default pull-right">
              @if(has_admin_portal_access())
                <li>
                  ...
                  <i class="fa fa-user-secret"></i>{{ Lang::get('dashboard.admin_view') }} </a>
                </li>
              @endif
                <li>
                  <a href="{{URL::to('/dashboard')}}" class="signin-dropdown-link">
                  <i class="fa fa-dashboard"></i>&nbsp;&nbsp;{{ Lang::get('dashboard.my_dashboard') }} </a>
                </li>
                <li>
                  <a href="{{URL::to('user/my-profile')}}" class="signin-dropdown-link">
                  <i class="fa fa-user"></i>&nbsp;&nbsp;{{ Lang::get('dashboard.my_profile') }} </a>
                </li>
                <li>
                  <a href="{{URL::to('user/my-address')}}" class="signin-dropdown-link">
                    <i class="fa fa-map-marker"></i>&nbsp;&nbsp;{{ Lang::get('dashboard.my_address') }} </a>
                </li>
                <li>
                  <a href="{{URL::to('auth/logout')}}" class="signin-dropdown-link">
                    <i class="fa fa-key"></i>&nbsp;&nbsp;{{ Lang::get('dashboard.sign_out') }} </a>
                </li>
          </ul>
      </li>
      </ul>
  ...
  <?php } ?>
      ...
      <div class="header-navigation">
        <ul>
          ...
          <li><a href="{{ URL::to('/emergency-medicine/#contact') }}">Contact Us</a></li>
        </ul>
      </div>
      <!-- END NAVIGATION -->
    </div>
