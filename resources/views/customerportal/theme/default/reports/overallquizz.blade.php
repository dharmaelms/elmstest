    ...
    <div class="row">
    		<div class="page-bar">
                ...
                <div class="page-breadcrumb pull-right">
                    <div class="box-tool">
                        <a  style="color:white;background-color:orange" href="{{URL::to('reports/quizz-performance')}}">Quizz Performance</a>
                    </div>
        		</div>
            </div>
			<div class="col-md-12">
		        <div class="box box-red">
		           <div class="box-title">
		                <h3 style="color:black"> Overall Performance across all Quizzes <span id='oa_per'></span></h3> 
		            </div>
