    ...
    <div class="row">
    		<div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li><a href="{{URL::to('reports/quizz-over-all-performance')}}">Reports</a><i class="fa fa-angle-right"></i></li>
                   	<li>Quiz performance </li>
                </ul>
                <div class="page-breadcrumb pull-right">
                    <div class="box-tool">
                        <a  style="color:white;background-color:orange" href="{{URL::to('/reports/area-improve')}}">Areas of Improvement</a>
                    </div>
        		</div>
            </div>
			...
			<div class="col-md-12">
		        <div class="box box-red">
		           <div class="box-title">
                   <h3 style="color:black"> Over all Quiz performance ...<?php if(isset($overallquizz) && !empty($overallquizz)){echo $overallquizz."%";}else{echo "0%";}?></h3> 
		                <!-- <h3 style="color:black"> Quiz performance </h3>  -->
		                <span id="no_quiz" style="display:none;color:orange">No quiz record found in this combination </span>
		                <div class="col-md-6  pull-right">
                            <form class="form-horizontal" action="">
                                <div class="form-group" >
                                  <label class="col-sm-4 col-lg-4 control-label" style="padding-right:10px;text-align:right"><b>Show on:</b></label>
                           ...
                           <!--              <option value="all" > All </option>
                                        ...
                                        <option value="all" <?php if(isset($show) && !empty($show) && $show=="all"){ echo "selected";}?> >All</option>
                                        <option value="fail" <?php if(isset($show) && !empty($show) && $show=="fail"){ echo "selected";}?>>Bellow  50% scored </option>
                                        <option value="pass" <?php if(isset($show) && !empty($show) && $show=="pass"){ echo "selected";}?>>Above  50% scored  </option>
                                       </select>
                                  </div>
                               </div>
                               <div class="form-group" >
                                        ...
                                        foreach ($quizz_titles as $key => $value) {
                                            ?>
                                                <tr>
                                                   ...
                                                   <td><a href="{{URL::to('/assessment/detail/'.$ids[$key])}}">Read more</a></td> 
                                                </tr>
                                            <?php
                                        }
                                    ?>
