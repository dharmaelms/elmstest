...
@section('content') 
    <style> 
        ...
        .dashboard7 .packet-title-dashboard7{height: 50px;overflow: hidden;}
        .content-row-dashboard7, .packet-container-dashboard7{width: 175px;}
        .packet-img-cont-dashboard7, .packet-img-cont-dashboard10{height: 112px;}
        .packet-container-dashboard7{min-height: auto;}
        @-moz-document url-prefix() {
            .packet-title .packet-title-dashboard7 {
            margin:0px !important;
            }
            }
            @media screen and (-webkit-min-device-pixel-ratio:0) {
      .packet-img-cont-dashboard7, .packet-img-cont-dashboard10 {
        height: 105px !important;

      }
      .packet-title-dashboard7 {
            margin: 0px !important;margin-bottom: 20px !important;
            }
            .packet-container-dashboard7{min-height: 160px !important;}
      }
      ...
      .panel-default{border-bottom: 0px solid #ddd !important;}
    </style> 
                ...
                <div class="row"> 
                    <div class="col-md-12"> 
                        <h3 class="black font-weight-500 margin-0 border-btm padding-btm-4 height33">
                            @if(array_get($general->setting, 'watch_now', 'on') == 'on' && $data['status'] == true)   
                ...
                @if($data['status'])  
                    @foreach($data['results']['data'] as $key_category => $category) 
                        ...
                        <div class="row margin-0"> 
                            <div class="col-md-12"> 
                                <h4 class="margin-top-10">{{ $category['title'] }}</h4> 
                            </div> 
                                               ...
                                               title="{{ $channel->program_title }}"> 
                                                <div class="packet packet-container-dashboard7"> 
                                                    ...
                                                    <div> 
                                                        ...
                                                        {{ str_limit($channel->program_title, $limit = 39, $end = '...') }}</p> 
                                                    </div> 
                                                </div><!--packet--> 
                                            </a> 
                                        </div><!--packet div--> 
                                                            ...
                                                            <div class="item white-bg content-row-dashboard7"> 
                                                                <a href="{{ URL::to('program/packets/'.$channel->program_slug)}}" title="{{ $channel->program_title }}"> 
                                                                    <div class="packet packet-container-dashboard7"> 
                                                                        ...
                                                                        <div> 
                                                                            <p class="packet-title packet-title-dashboard7">{{ str_limit($channel->program_title, $limit = 39, $end = '...') }}</p> 
                                                                        </div> 
                                                                    </div><!--packet--> 
                                                                </a> 
                                                           </div><!--packet div--> 
    ...
    <script>
        ...
        var announcement = (function () {
            var limit = 2,
                    ...
                    content = '<li class="xs-margin" data-page-id="{page}">' +
                            '<p class="black margin-0" style="word-wrap: break-word; font-size: 15px !important;">{title}</p>' +
                            '<p class="font-10 gray margin-0" data-announcement-id="{id}" style="font-size: 13px !important;">{description}</p>' +
        ...
        var event = (function () {
            ...
            content =
                    ...
                    '<p class="black margin-0" style="font-size: 15px !important;">{title}</p>' +
                    '<p class="font-10 gray margin-0" style="font-size: 13px !important;">{description}</p>' +
