          ...
          <div class="col-md-12">
            ...
            <div class="right-table">
              <div class="table-responsive">
                ...
                <span class="title-box1">{{Lang::get('dashboard.my_courses')}}</span>
                ...
                <div class="padding-lft-30">
                  <table class="table" id="programs">
                    <thead>
                    <tr>
                      <th width="200px">{{Lang::get('dashboard.course_name')}}</th>
                    </tr>
                    </thead>
                    <tbody>
                    </tbody>
              ...
              <div>
                <a href="{{ URL::to('/program/my-feeds') }}" class="btn btn-primary btn-sm pull-right">{{Lang::get('dashboard.view_all')}}</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row md-margin" id="latestcourses">
          <div class="col-md-12">
            ...
            <div class="right-table">
              <div class="table-responsive">
                ...
                <div class="padding-lft-30">
                  <table class="table" id="posts">
                    <thead>
                    <tr>
                      <th width="200">{{Lang::get('dashboard.post_name')}}</th>
                      <th width="140">{{Lang::get('dashboard.post_course_name')}}</th>
                      <th width="60">{{Lang::get('dashboard.post_content')}}</th>
                      <!-- due to mongo load hidden status feature -->
                      <th width="80" class="center">{{Lang::get('dashboard.post_q_a')}}</th>
                    </tr>
                    </thead>
                    <tbody>
                    </tbody>
              ...
              <div>
                <a href="{{ URL::to('/program/what-to-watch') }}" class="btn btn-primary btn-sm pull-right">{{Lang::get('dashboard.view_all')}}</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row md-margin" id="assess">
          <div class="col-md-12">
            ...
            <div class="right-table">
              <div class="table-responsive">
                <span class="title-box"></span>
                <span class="title-box1" style="color:#14AAB9;">{{Lang::get('dashboard.assessment')}}</span>
                <div class="nav-buttons pull-right">
                ...
                <div class="padding-lft-30">
                  <table class="table" id="quiz">
                    <thead>
                    <tr>
                      <th width="200">{{Lang::get('dashboard.assessment_name')}}</th>
                      <th width="110">{{Lang::get('dashboard.assessment_starts')}}</th>
                      <th width="110">{{Lang::get('dashboard.assessment_ends')}}</th>
                      <th width="100" class="center">{{Lang::get('dashboard.assessment_no_of_questions')}}</th>
                      <th width="80">{{Lang::get('dashboard.assessment_duration')}}</th>
                    </tr>
                    </thead>
                    <tbody>
                    <!-- data inserted here -->
              ...
              <div>
                <a href="{{ URL::to('/assessment') }}" class="btn btn-primary btn-sm pull-right">{{Lang::get('dashboard.view_all')}}</a>
              </div>
            </div>
          </div>
        </div>
                      ...
                      $.each(response.results, function(index,result) {
                          $(position).append(
                              content.replace(/{page}/g, page)
                                  ...
                                  .replace(/{title}/g, stripText(result.program_title, 200)+" ")
