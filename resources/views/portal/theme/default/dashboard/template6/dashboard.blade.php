@section('content')
    <style>
        ...
        .packet-img-cont-dashboard6 img {
    ...
    <div class="row dashboard1">
        @if(array_get($lhs_menu_settings->setting, 'programs', 'on') == "on")
            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12 dashboard6 db-main-content" id="db-maincontent">
                <div class="row">
                    <div class="col-md-12">
                ...
                <br>
                @if($data['status'])
                    @foreach($data['results']['data'] as $category)
                        <div class="row margin-0">
                            <div class="col-md-12">
                                <h4 class="margin-top-10"><a>{{ $category['title'] }}</a></h4>
                            </div>
                            <div class="col-md-12 nav-space sm-margin border-btm">
                                <div class="owl-carousel owl-theme sm-margin owl-carousel-dashboard6">
                                    @foreach($category['data'] as $channel)
                                        <div class="item white-bg content-row-dashboard6">
                                            <a href="{{ URL::to('program/packets/'.$channel->program_slug)}}"
                                               title="{{ $channel->program_title }}">
                                                <div class="packet packet-container-dashboard6">
                                                    <div class="packet-img-cont-dashboard6">
                                                        @if( isset($channel->program_cover_media) && !empty($channel->program_cover_media) )
                                                            <img src="{{URL::to('media_image/'.$channel->program_cover_media)}}" alt="Channel" class="packet-img img-responsive packet-img-dashboard6" style="max-height: 124px;">
                                                        @else
                                                            <img src="{{URL::asset($theme.'/img/default_channel.png')}}"
                                                                 alt="Channel" class="packet-img img-responsive packet-img-dashboard6">
                                                        @endif
                                                    </div>
                                                    <div>
                                                        <p class="packet-title packet-title-dashboard6">
        ...
        <div class="col-md-3 col-sm-12 col-xs-12 db-side-bar" id="db-sidebar">
            <div class="annoucements-div1 sm-margin">
                <div class="title-border">
                    <h4 class="black font-weight-500">{{trans("dashboard.$site.announcements")}}</h4>
