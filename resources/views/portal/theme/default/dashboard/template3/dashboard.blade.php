                ...
                <div class="padding-lft-30">
                  <table class="table" id="programs">
                    ...
                    <tr>
                      ...
                      <th width="100">{{trans('dashboard.course_starts')}}</th>
                      <th width="100">{{trans('dashboard.course_ends')}}</th>
                      <th width="120">{{trans('dashboard.course_progress')}}</th>
                      ...
                      $.each(response.results, function(index,result) {
                          $(position).append(
                              content.replace(/{page}/g, page)
                                  ...
                                  .replace(/{title}/g, stripText(result.program_title, 20)+" ")
                      ...
                      $.each(response.results, function(index,result) {
                          $(position).append(
                              content.replace(/{page}/g, page)
                                  ...
                                  .replace(/{title}/g, stripText(result.packet_title, 25))
                      ...
                      $.each(response.result, function(index,data) {
                          $(position).append(
                              content.replace(/{page}/g, page)
                                  ...
                                  .replace(/{name}/g, stripText(data.quiz_name, 20))
