    ...
    <div class="row">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>{{Lang::get('reports.course_completion_status_report')}}</li>
                </ul>
            </div>
			<div class="col-md-12">
		        <div class="box box-red">
		           <div class="box-title">
                    <h3 style="color:black"> Over all {{Lang::get('reports.courses')}} ...<?php if(isset($overall_perf) && !empty($overall_perf)){echo $overall_perf."%";}else{echo "0%";}?></h3> 
