    ...
    <div class="col-md-12">
        <div class="box box-red">
            <div class="box-title btm-shadow sm-margin">
                <h3 class="padding-btm-10">{{ Lang::get('reports.area_of_improvement') }}</h3> 
                <span id="no_quiz" style="display:none;color:orange">No {{Lang::get('program.course')}} for improve </span>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div id = "report_tbl">
                                <table width="100%">
                                    <tr>
                                        <th> {{Lang::get('program.course')}} Name</th>
                                        <th>{{ Lang::get('reports.avg_scores_wp') }}</th>
                                    </tr>
