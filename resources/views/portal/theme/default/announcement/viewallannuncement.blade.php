...
<div>
	<div id='notifi_div_tab'>
		<button class="Notifications_btn">
			<?php Lang::get('announcement.notification') ?>	
		</button>
	</div>
	<div id='announce_div_tab'>
		<button class="Announcement_btn" >
			 <?php Lang::get('announcement.announcements') ?> 
		</button>
	</div>
</div>
<div id="content_list_announce">
<h1><?php echo Lang::get('announcement.list_announcement') ?></h1>
<?php 
        ...
        if(isset($spec_user_annonce) && !empty($spec_user_annonce)){
            foreach ($spec_user_annonce as $key => $value) {
				...
				<!-- <li id="basic-modal" class="xs2-margin"> -->
                  ...
                  ?>
                   		<span class="black"><?php print_r($disp_cont)?></span>
                	</div>
                  </td>
                   <td width="20px"></td>
                  <td>
...
<div id='content_list_notification'>
	<span>  <?php echo Lang::get('announcement.Permission_denied'); ?></span>
</div>
<div id="test">
