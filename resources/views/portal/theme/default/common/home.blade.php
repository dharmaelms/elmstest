@section('content')
    ...
    <!--  <link href="{{ URL::asset($theme.'/plugins/assets/global/plugins/carousel-owl-carousel/owl-carousel/owl.carousel.css')}}" rel="stylesheet">-->
...
<div class="home1">
    <!-- coding for non ecommerce sites -->
    @if(!config('app.ecommerce'))
    <div class="container container-head-top">
        <div class="row">
            <div class="page-slider col-xs-12 col-sm-7 col-md-7 col-lg-8">
                <div class="fullwidthbanner-container revolution-slider margin-btm-0">
                    <div class="fullwidthbanner2">
                        <ul id="revolutionul">
                            ...
                            <li data-transition="fade" @if(isset($banner['banner_url']) && ($banner['banner_url'] != '') && (!empty($banner['banner_url']))) data-link="{{$banner['banner_url']}}" data-target="_blank" @endif data-slotamount="1" data-masterspeed="700" data-delay="9400">
                                <img src="{{URL::to(str_replace(' ', '%20', $banner_file_path))}}" alt="Banner">
            ...
            <div class="col-xs-12 col-sm-5 col-md-5 col-lg-4 pull-right">
                <center>
                    ...
                    ?>
                    <a href="#">
                        <img src="{{ URL::to($logo) }}" style="margin-top:80px;">
                    </a>
                </center>
            </div>
    ...
    <!-- coding for non ecommerce sites ends -->
    @else
        <!-- BEGIN SLIDER -->
                                ...
                                @if(!isset($upcoming['parent_id']) || $upcoming['parent_id'] == 0)
                                    ...
                                    <span class="left">
                                        ...
                                        <span class="red">{{ Lang::get('announcement.end_date') }}</span> <br>
                                            ...
                                            <div class="course-detail"><p class="font-13">{{str_limit($upcoming['program_description'], $limit = 180, $end = '...')}}</p><p class="center font-13"><a class="btn btn-success" href="{{ URL::to('catalog/course/'.$upcoming['program_slug']) }}">{{Lang::get('announcement.view_course')}}</a></p></div>
                                        </div>
                                    </div>
                                @endif
                            @endforeach
                    ...
                    @if(Auth::check())
                        @if(isset($announcements) && !empty($announcements))
                            <div class="col-md-offset-1 col-md-5 col-sm-6 col-xs-12">
                                ...
                                <div class="announce-tabs">
                                    <h3><span class="black font-weight-500">{{trans('announcement.announcements')}}&nbsp;&nbsp;|&nbsp;&nbsp;</span><a href="{{ URL::to('announcements?announcement=public') }}" class="font-16">{{trans('announcement.view_all')}}</a></h3>
                                    <ul>
                                        @foreach ($announcements as $key => $value)
                                            <li>
                                                <div class="col-md-12 padding-0">
                                                    ...
                                                    <div class="data-div" style="word-wrap: break-word;">
                        ...
                        @else
                            <div class="col-md-offset-1 col-md-5 col-sm-6 col-xs-12">
                                <div class="md-margin"></div>
                                <div class="announce-tabs">
                                    <h3><span class="black font-weight-500">{{trans('announcement.announcements')}}</span></h3>
                                    <p>{{trans('pagination.no_announce_published')}}</p>
