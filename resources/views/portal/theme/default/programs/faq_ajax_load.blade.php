	...
	<li class="media">
		...
		<div class="media-body todo-comment">
			...
			<p class="todo-text-color">{{$public['question']}}&nbsp;&nbsp;
				...
				@endif
				<span class="faq-like">
					<i id="{{$public['id']}}" data-action="{{$action}}" data-packet="{{$packet['packet_id']}}" class="cursor-pointer fa fa-thumbs-up {{$class}} like-faq"></i>
				</span>	
			</p>
			<!-- Nested media object -->
			<?php 
			...
			@foreach($answers as $answer)
				<div class="media">
					<a class="pull-left" href="javascript:;">
					<?php 
						$pic = (isset($answer['profile_pic'])) ? URL::asset(config('app.user_profile_pic') . $answer['profile_pic'] ) : URL::asset($theme.'/img/green.png');
					?>
