        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-content">
                    <form action="{{ URL::to("cp/survey/add-survey") }}" class="form-horizontal form-bordered form-row-stripped" method="post" id="survey_form" onsubmit="formSubmit()">
                        <div class="form-group">
                            <label for="quiz_name" class="col-sm-3 col-lg-2 control-label">{{trans('admin/survey.title')}}<span class="red">*</span></label>
                            <div class="col-sm-9 col-lg-6 controls">
                                <input type="text" name="survey_title" id="survey_title" class="form-control" value="{{ Input::old('survey_title')}}">
...
<!--                    <div class="form-group">
                            ...
                            <div class="col-sm-5 col-lg-3 controls score_display">
                                <input type="checkbox" name="display_report">
                            </div>
                        </div> -->
