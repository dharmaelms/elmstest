    ...
    <div class="row custom-box">
            ...
            <div class="box">
                 <div class="box-title">
                    ...
                    <div class="btn-toolbar pull-right clearfix"> 
                        <a href="{{URL::to('cp/reports/direct-quiz-user')}}"  class="show-tooltip btn btn-primary fa fa-angle-left"> <?php echo trans('admin/reports.back'); ?></a>
                    </div>
                </div>
                    ...
                    <table class="table table-advance" id="datatable">
                        <thead>
                            <tr>
                                ...
                                <th title="{{$total_time}}"> Time taken</th>
                                @if(isset($ques_list))
        ...
        <script>
            ...
            $('#exp_report').click(function(){
                var url = '{{URL::to('/')}}';
                location.href = url+'/cp/reports/csv-direct-quiz-performance-by-question/'+quiz_name_js+'/'+total_time_js+'/'+total_mark_js+'?quiz_id='+quiz_id_js+'&ques_ids='+ques_ids_js;
            });
            /* Simple Loader */
            ...
            $(document).ready(function(){
                ...
                window.datatableOBJ = $('#datatable').on('processing.dt',function(event,settings,flag){
                    ...
                    "serverSide": true,
                    "ajax": {
                        "url": "{{URL::to('cp/reports/ajax-direct-quiz-performance-by-question/')}}",
                        "type": "POST",
                        "data": function ( d ) {
