	        ...
	        <div class="box">
	            <div class="box-content">
	            	...
	            	<div class="btn-toolbar clearfix">                       
						...
						<a class="btn btn-gray show-tooltip" title="{{ trans('admin/user.user_ug_template1') }}"
						  href="{{ URL::to('cp/usergroupmanagement/user-to-usergroup1') }}"  
						  style="margin-left: 6px;">
						  <i class="fa fa-download">&nbsp;{{ trans('admin/user.user_ug_template1') }}</i></a>
					...
					<div @if(!Input::old() && !(isset($errorflag))) style="display:none;" @endif id="show_form">
		            	<form action="{{URL::to('cp/usergroupmanagement/import-user-to-usergroup')}}" 
							...
							<div class="form-group last">
								<div class="col-sm-offset-3 col-sm-9 col-lg-offset-3 col-lg-9">
									...
									<a href="{{URL::to('/cp/usergroupmanagement/user-groups')}}" >
	    ...
	    <div class="modal-dialog">
	                    ...
	                    <div class="col-md-12">
	                        <div class="box">
	                            <div class="box-title">
	                                ...
	                                {{ trans('admin/user.user_usergroup_import_information') }}</h3>
	                            </div>
	                        </div>
	                    </div>
	                </div>
            ...
            <!--content-->
	      		<div class="modal-body">
	                <br>
	                <ul>
	                	{!! trans('admin/user.assign_user_usergroup_help_note') !!}
	                </ul>
	                <br>
			  	</div>
			  	<!--footer-->
	...
	<div id="list_user" class="modal fade">
	    <div class="modal-dialog">
	                    ...
	                    <div class="col-md-12">
	                        <div class="box">
	                            <div class="box-title">
	                                <button type="button" class="close" data-dismiss="modal" 
	                                	aria-hidden="true">×</button>
	                                <h3><i class="icon-file"></i>{{ trans('admin/user.list_user_group') }}</h3>
	                            </div>
	                        </div>
	                    </div>
	                </div>
            ...
            <!--content-->
			  	...
			  	<!--footer-->
			  	<div class="modal-footer">
		      		<a class="btn btn-success" data-dismiss="modal" >{{ trans('admin/user.ok') }}</a>
		  		</div>
			</div>
		</div>
	</div>
