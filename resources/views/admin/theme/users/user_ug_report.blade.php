	        ...
	        <div class="box">
				...
				<div class="col-md-12 margin-bottom-20">
					<div class="btn-toolbar pull-right clearfix">
            		    <div class="btn-group">
							<input type="hidden" id="export_link" name="export_link" value="{{URL::to('/cp/usergroupmanagement/user-ug-export')}}">
							<a class="btn btn-primary btn-sm" id= "export_link_user"  href="{{URL::to('/cp/usergroupmanagement/user-ug-export')}}"><?php echo trans('admin/user.export_log') ?></a>
							<a class="btn btn-primary btn-sm" style= "margin-left:5px;"
							   title="<?php echo trans('admin/user.user_ug_template'); ?>"
							   href="{{URL::to('/cp/usergroupmanagement/update-user-ug-template')}}">
								<i class="fa fa-download">&nbsp;</i>
                                <?php echo trans('admin/user.user_ug_template'); ?>
							</a>
							<a class="btn btn-circle show-tooltip" title="{{ trans('admin/user.user_ug_import_help') }}"
                    ...
                    <form class="form-horizontal" action="" name="filterform">
			            	...
			            	<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 margin-bottom-20">
									...
									<div class="form-group">
		                              ...
		                              <div class="col-sm-6 col-lg-6 controls" style="padding-left:0;">
		                                ...
		                                <select class="form-control chosen" name="filters" id="filters" data-placeholder="ALL" >
		                                    ...
		                                    <option value="assign" <?php if ($filters == 'assign') echo 'selected';?>>Assign</option>
		                                    <option value="unassign" <?php if ($filters == 'unassign') echo 'selected';?>>Unassign</option>
		                                </select>
		                              </div>
		                           </div>
									...
									<div class="form-group last">
										...
										<a href="{{URL::to('/cp/usergroupmanagement/user-usergroup-report')}}"><button type="button" class="btn"><?php echo trans('admin/user.clear') ?></button></a>
										</div>
									</div>
	    ...
	    <div class="modal-dialog">
	                    ...
	                    <div class="col-md-12">
	                        <div class="box">
	                            <div class="box-title">
	                                ...
	                                <h3><i class="icon-file"></i><?php echo trans('admin/user.user_ug_import_information'); ?></h3>
	                            </div>
	                        </div>
	                    </div>
	                </div>
            ...
            <!--content-->
	      		<div class="modal-body">
	                <br>
	                <ul>
	                	<?php echo trans('admin/user.user_ug_import_help_note'); ?>
	                </ul>
	                <br>
			  	</div>
			  	<!--footer-->
	    ...
	    <script>
	    	...
	    	$(document).ready(function(){
	    		...
	    		window.datatableOBJ = $datatable.on('processing.dt',function(event,settings,flag){
	    			...
	    			"serverSide": true,
					"ajax": {
			            "url": "{{URL::to('/cp/usergroupmanagement/user-ug-import-list')}}",
			            "data": function ( d ) {
