            ...
            <div class="box">
                <div class="box-content">
                    ...
                    <div class="btn-toolbar clearfix">                       
                        ...
                        <a class="btn btn-gray show-tooltip" title="<?php echo trans('admin/user.bulk_delete_users_template'); ?>" href="{{ URL::to('cp/usergroupmanagement/bulk-delete-users-excel') }}"  style="margin-left: 6px;"><i class="fa fa-download">&nbsp;<?php echo trans('admin/user.bulk_delete_users_template'); ?></i></a>
                    ...
                    <div @if(!Input::old() && !(isset($errorflag))) style="display:none;" @endif id="show_form">
                        <form action="{{URL::to('cp/usergroupmanagement/bulk-delete-users')}}" class="form-horizontal form-bordered form-row-stripped" method="post" enctype='multipart/form-data'>
                                ...
                                <div class="col-sm-6 col-lg-5 controls">
                                    ...
                                    <?php if((isset($errorflag)) && ($errorflag == 1)){ ?>  
                                        <span class="help-inline" style="color:#f00">
                                            <?php echo trans('admin/user.bulk_delete_users_format_error_excel'); ?>
        ...
        <div class="modal-dialog">
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-title">
                                    ...
                                    <h3><i class="icon-file"></i><?php echo trans('admin/user.bulk_delete_users_information'); ?></h3>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!--content-->
                <div class="modal-body">
                    <br>
                    <ul>
                        <?php echo trans('admin/user.bulk_delete_users_upload_help_note'); ?>
                    </ul>
                    <br>
                </div>
                <!--footer-->
