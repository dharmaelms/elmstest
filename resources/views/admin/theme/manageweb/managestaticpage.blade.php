                ...
                <div class="box-content">
                    <div class="btn-toolbar clearfix">
                        ...
                        <div class="pull-right">
                            <div class="btn-group">
                            <!--   <a class="btn btn-circle show-tooltip" title="{{trans('admin/manageweb.add_static_page')}}" href="{{url::to('/cp/manageweb/static-pages?opration=add')}}"><i class="fa fa-plus"></i></a>
 -->
                                <a class="btn btn-primary btn-sm"href="{{url::to('/cp/manageweb/static-pages?opration=add')}}">
                                        <span class="btn btn-circle blue show-tooltip custom-btm">
                                            <i class="fa fa-plus"></i>
                                        </span>{{trans('admin/manageweb.add_static_page')}}
                                </a>&nbsp;&nbsp;
                            </div>
                    ...
                    <table class="table table-advance" id="datatable">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:left">{{trans('admin/manageweb.title')}}</th>
                                <th style="text-align:left">{{trans('admin/manageweb.meta_key')}}</th>
                                <!-- <th>Asset Type</th> -->
                                ...
                                <div class="box">
                                    <div class="box-title">
                                        ...
                                        <h3 class="modal-header-title" >
                                            <i class="icon-file"></i>
                                                {{trans('admin/manageweb.view_static_details')}}
                                        </h3>                                                
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="box">
                                    <div class="box-title">
                                        ...
                                        <h3 class="modal-header-title" >
                                            <i class="icon-file"></i>
                                                {{trans('admin/manageweb.static_page_delete')}}
                                        </h3>                                                
                                    </div>
                                </div>
                            </div>
    ...
    <script>
            ...
            $(document).ready(function(){
                ...
                window.datatableOBJ = $('#datatable').on('processing.dt',function(event,settings,flag){
                    ...
                    "serverSide": true,
                    "ajax": {
                        "url": "{{URL::to('/cp/manageweb/staticpages-list-ajax')}}",
                        "data": function ( d ) {
                ...
                $('.bulkdeletemedia').click(function(e){
                    ...
                    if(!checkedboxes.length){
                        alert('Please select atleast one static page');
                    }
                    else{
                        var html = "<strong>";
                        var ids = ""
                        ...
                        $('#bulkdeletebtn').unbind('click').click(function(e){
                            e.preventDefault();
                            var $form = $('<form></form>').prop('action','{{URL::to('/cp/manageweb/bulk-delete')}}').attr('method','post');
