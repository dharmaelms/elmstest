        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-content">
                    <form action="{{ URL::route('post-add-assignment') }}" class="form-horizontal form-bordered form-row-stripped" method="post" id="survey_form" onsubmit="formSubmit()">
                        <div class="form-group">
                            <label class="col-sm-3 col-lg-2 control-label">{{trans('admin/assignment.assignment_title')}}<span class="red">*</span></label>
                            <div class="col-sm-9 col-lg-6 controls">
                                <input type="text" name="assignment_title" id="assignment_title" class="form-control" value="{{ Input::old('assignment_title')}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-6 controls">
                                <textarea name="assignment_description" rows="5" class="form-control ckeditor">{!! Input::old('assignment_description') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3 controls">
                                <div class="input-group date">
                                    ...
                                    <input type="text" name="start_date" class="form-control assignment-start-date" style="cursor: pointer" value="{{ Input::old('start_date', Timezone::convertFromUTC('@'.time(), Auth::user()->timezone, 'd-m-Y')) }}" readonly="readonly">
                                </div>
                            ...
                            <div class="col-lg-2 controls">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="start_time" onclick="$(this).prev().click()" class="form-control assignment-start-time" style="cursor: pointer" value="{{ Input::old('start_time',Timezone::convertFromUTC('@'.time(), Auth::user()->timezone, 'H:i')) }}" readonly="readonly">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3 controls">
                                <div class="input-group date">
                                    <span class="input-group-addon" onclick="$(this).next().focus()"><i class="fa fa-calendar"></i></span>
                                    <input type="text" name="end_date" class="form-control assignment-end-date" style="cursor: pointer" value="{{ Input::old('end_date', Timezone::convertFromUTC('@'.time(), Auth::user()->timezone, 'd-m-Y')) }}" readonly="readonly">
                                </div>
                            ...
                            <div class="col-lg-2 controls">
                                <div class="input-group">
                                    <span class="input-group-addon" href="#"><i class="fa fa-clock-o"></i></span>
                                    <input type="text" name="end_time" onclick="$(this).prev().click()" class="form-control assignment-end-time" style="cursor: pointer" value="{{ Input::old('end_time',Timezone::convertFromUTC('@'.time(), Auth::user()->timezone, 'H:i')) }}" readonly="readonly">
                                    <span class="input-group-btn">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3 controls">
                                <div class="input-group date">
                                    <span class="input-group-addon" onclick="$(this).next().focus()"><i class="fa fa-calendar"></i></span>
                                    <input type="text" name="cutoff_date" class="form-control assignment-cutoff-date" style="cursor: pointer" value="{{ Input::old('cutoff_date', Timezone::convertFromUTC('@'.time(), Auth::user()->timezone, 'd-m-Y')) }}" readonly="readonly">
                                </div>
                            ...
                            <div class="col-lg-2 controls">
                                <div class="input-group">
                                    <span class="input-group-addon" href="#"><i class="fa fa-clock-o"></i></span>
                                    <input type="text" name="cutoff_time" onclick="$(this).prev().click()" class="form-control assignment-cutoff-time" style="cursor: pointer" value="{{ Input::old('cutoff_time',Timezone::convertFromUTC('@'.time(), Auth::user()->timezone, 'H:i')) }}" readonly="readonly">
                                    <span class="input-group-btn">
                            ...
                            <div class="col-sm-5 col-lg-3 controls submission_type">
                                <div class="input-group">
                                    <label class="radio-inline">
                                        <input type="radio" value="online_text" id="online_text" name="submission_type" checked >{{ trans('admin/assignment.inline_text') }}
                                    </label>&nbsp;&nbsp;&nbsp;
                                    <label class="radio-inline">
                                        <input type="radio" value="file_submission" id="submission" name="submission_type" @if(Input::old('submission_type') == "file_submission") checked @endif >{{ trans('admin/assignment.file_submission') }}
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class='upload-file'>
                                ...
                                <div class="col-sm-9 col-lg-6 controls">
                                    <input type="number" name="max_files" id="max_files" class="form-control" value="1" min="1" max="10" style="width: 30%;">
                            ...
                            <div class="col-sm-9 col-lg-6 controls">
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="input-group template_uploads">
                                        <input type="hidden" class="file-input" name="template_file_id" id="template_file_id">
                                        <input type="hidden" class="file-input" name="template_file_name" id="template_file_name">
                                        <i class="fa fa-file fileupload-exists"></i>
                                        <input class="fileupload-preview form-control uneditable-input" type="text" value="{{ Input::old('template_file_name') }}" disabled>
                                ...
                                {!! $errors->first('template_file', '<span class="help-inline" style="color:#f00">:message</span>') !!}
                            </div>
                            </div>                        <div class="form-group">
                            <label class="col-sm-3 col-lg-2 control-label">{{trans('admin/assignment.grade')}}</label>
                            <div class="col-sm-9 col-lg-6 controls">
                                <input type="number" min="1" max="100" name="grade" id="grade" class="form-control" value="{{ Input::old('grade')}}" style="width: 30%;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-6 controls">
                                <input type="number" min="0" name="grade_cutoff" id="grade_cutoff" class="form-control" value="{{ Input::old('grade_cutoff')}}" style="width: 30%;">
