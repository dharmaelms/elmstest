...
<form action="{{URL::to('cp/forum/update-forum')}}" class="form-horizontal form-bordered form-row-stripped" method="post" id="uploadform" style="margin-top:10px;" enctype='multipart/form-data' > 
			<div class="form-group">
							<label class="col-sm-3 col-lg-2 control-label"> Forum Title</label>
							<div class="col-sm-9 col-lg-10 controls">
								<input type="text" name="title" class="form-control" value="{{$forum[0]->forum_title}}" />
			...
			<input name="forum_slug" type="hidden" value="{{$forum[0]->forum_slug}}">
			<div class="form-group">
							...
							<div class="col-sm-9 col-lg-10 controls">
								...
								<span class="help-inline">Select here make Open or Closed This forum</span>
							</div>
			...
			<div class="form-group">
							...
							<div class="col-sm-9 col-lg-10 controls">
								...
								<span class="help-inline">Select visiblity control here</span>
								{!! $errors->first('media_type', '<span class="help-inline" style="color:#f00">:message</span>') !!}
							</div>
			</div>
			...
			<div class="form-group">
							...
							<div class="col-sm-9 col-lg-10 controls">
								<textarea class="form-control" rows="3" name="forum_description" >{{$forum[0]->forum_description}}</textarea>
			...
			<div class="form-group">
							...
							<div class="col-sm-9 col-lg-10 controls">
								<textarea class="form-control" rows="6	" name="admin_description" >{{$forum[0]->admin_description}}		</textarea>
