    ...
    <div class="row">
                    ...
                    <table class="table table-advance" id="datatable">
                        <thead>
                            <tr>
                                ...
                                <th style="width:250px">{{trans('admin/program.packet')}}</th>
                                <th style="width:250px">{{trans('admin/assessment.channel')}}</th>
        ...
        $(document).ready(function(){
            ...
            window.datatableOBJ = $datatable.on('processing.dt',function(event,settings,flag){
                ...
                "serverSide": true,
                "ajax": {
                    "url": "{{URL::to('/cp/contentfeedmanagement/all-questions-ajax/')}}",
                    "data": function ( d ) {
