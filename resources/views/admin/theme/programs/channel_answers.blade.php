@section('content')
	...
	<div class="row">
	            ...
	            <div class="box-content">
                    ...
                    <ul class="messages messages-chatty">
							    ...
							    <li class="<?php echo (isset($question['user_id']) && $answer['user_id'] == $question['user_id']) ? "left" : "right"; ?>">
							        ...
							        <div>
							            <div>
                                            ...
                                            <a class="btn btn-circle show-tooltip answerdelete" style="background-color:darkgrey;color:white"
                                               title="{{trans('admin/program.delete_answer')}}"
                                               href="{{URL::to("/cp/contentfeedmanagement/delete-channel-answer/{$program_id}/{$question->id}/{$answer["id"]}")}}" >
                                                <i class="fa fa-trash-o"></i>
                                            </a>
							                <span class="time">
                                                <i class="fa fa-clock-o"></i>
                                                {{ Timezone::convertFromUTC("@".$answer['created_at'],Auth::user()->timezone,'Y-m-d H:i') }}
                                            </span>
							            </div>
						            	<p>{{$answer['answer']}}</p>
							        </div>
					    ...
					    <div class="messages-input-form">
                            <form method="POST" action="{{URL::to("/cp/contentfeedmanagement/channel-answer/{$program_id}/{$question["id"]}")}}">
                                <div class="input">
                                    <input type="text" name="answer" placeholder="Write here..." class="form-control" value="{{Input::old('answer')}}">
                                </div>
                                <div class="buttons">
        ...
        <div class="modal fade" id="answerunhide" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="box">
                                    <div class="box-title">
                                        ...
                                        <h3 class="modal-header-title" >
                                            <i class="icon-file"></i>
                                                {{trans('admin/program.unhide_answer')}}
                                        </h3>                                                
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-body" style="padding-left: 20px;">
                        {{trans('admin/program.modal_unhide_answer')}}
                    </div>
                    <div class="modal-footer">
                        <a class="btn btn-danger" id="actionbtn">{{trans('admin/program.yes')}}</a>
                        <a class="btn btn-success" data-dismiss="modal">{{trans('admin/program.close')}}</a>
        ...
        <div class="modal fade" id="answerhide" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="box">
                                    <div class="box-title">
                                        ...
                                        <h3 class="modal-header-title" >
                                            <i class="icon-file"></i>
                                                {{trans('admin/program.hide_answer')}}
                                        </h3>                                                
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-body" style="padding-left: 20px;">
                        {{trans('admin/program.modal_hide_answer')}}
                    </div>
                    <div class="modal-footer">
                        <a class="btn btn-danger" id="actionbtn">{{trans('admin/program.yes')}}</a>
                        <a class="btn btn-success" data-dismiss="modal">{{trans('admin/program.close')}}</a>
        ...
        <script>
            $(document).ready(function(){
                ...
                $('.answerhide').click(function(e){
                    e.preventDefault();
                    var $modal = $('#answerhide');
                    var $this = $(this);
                    $modal.find('.modal-footer a#actionbtn').attr('href',$this.attr('href'));
                    $modal.modal('show');
                });
                $('.answerunhide').click(function(e){
                    e.preventDefault();
                    var $modal = $('#answerunhide');
                    var $this = $(this);
                    $modal.find('.modal-footer a#actionbtn').attr('href',$this.attr('href'));
                    $modal.modal('show');
                });
