                ...
                <div class="box-content">
                    ...
                    <ul class="messages messages-chatty">
                                ...
                                <li class="<?php echo (isset($question['user_id']) && $answer['user_id'] == $question['user_id']) ? "left" : "right"; ?>">
                                    ...
                                    <div>
                                        <div>
                                            ...
                                            @if($answer['user_id'] == Auth::user()->uid ) 
                                                <a class="btn btn-circle show-tooltip answerdelete" style="background-color:darkgrey;color:white" title="Delete this answer" href="{{URL::to('/cp/contentfeedmanagement/delete-packet-answer/'.$answer['id'])}}" ><i class="fa fa-trash-o"></i>
                                                </a>
                                            @endif
                        ...
                        <div class="messages-input-form">
                            <form method="POST" action="{{URL::to('/cp/contentfeedmanagement/write-packet-answer/'.$id)}}">
                                <div class="input">
