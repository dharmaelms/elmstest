	        ...
	        <div class="box">
				...
				<div class="col-md-12 margin-bottom-20">
					<div class="btn-toolbar pull-right clearfix">
            		    <div class="btn-group">
							<input type="hidden" id="export_link_pack" name="export_link_pack" value="{{URL::to('/cp/bulkimport/package-export/')}}">
							<a class="btn btn-primary btn-sm" id= "export_link"  href="{{URL::to('/cp/bulkimport/package-export/')}}"><?php echo trans('admin/user.export_log') ?></a>
							<a class="btn btn-primary btn-sm" style= "margin-left:5px;"
							   title="<?php echo trans('admin/program.import_add_package_template'); ?>"
							   href="{{URL::to('/cp/bulkimport/import-add-program-template/'.$program_type.'/'.$program_sub_type.'/'.$action='ADD')}}">
								<i class="fa fa-download">&nbsp;</i>
                                <?php echo trans('admin/program.import_add_package_template'); ?>
							</a>
							<a class="btn btn-primary btn-sm" style= "margin-left:5px;"
							   title="<?php echo trans('admin/program.import_update_package_template'); ?>"
							   href="{{URL::to('/cp/bulkimport/import-update-program-template/'.$program_type.'/'.$program_sub_type.'/'.$action='UPDATE')}}">
								<i class="fa fa-download">&nbsp;</i>
                                <?php echo trans('admin/program.import_update_package_template'); ?>
							</a>
							<a class="btn btn-circle show-tooltip" title="{{ trans('admin/program.package_import_help') }}" data-toggle="modal" href="#help" style="margin-left: 6px;"><i class="fa fa-question"></i></a>
                    ...
                    <form class="form-horizontal" action="" name="filterform">
			            	...
			            	<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 margin-bottom-20">
									...
									<div class="form-group last">
										...
										<a href="{{URL::to('/cp/bulkimport/package-import-report')}}"><button type="button" class="btn"><?php echo trans('admin/user.clear') ?></button></a>
										</div>
									</div>
	    ...
	    <div class="modal-dialog">
	                    ...
	                    <div class="col-md-12">
	                        <div class="box">
	                            <div class="box-title">
	                                ...
	                                <h3><i class="icon-file"></i><?php echo trans('admin/program.package_import_information'); ?></h3>
	                            </div>
	                        </div>
	                    </div>
	                </div>
            ...
            <!--content-->
	      		<div class="modal-body">
	                <br>
	                <ul>
	                	<?php echo trans('admin/program.package_import_help_note'); ?>
	                </ul>
	                <br>
			  	</div>
			  	<!--footer-->
	    ...
	    <script>
	    	...
	    	$(document).ready(function(){
	    		...
	    		window.datatableOBJ = $datatable.on('processing.dt',function(event,settings,flag){
	    			...
	    			"serverSide": true,
					"ajax": {
			            "url": "{{URL::to('/cp/bulkimport/package-import-list')}}",
			            "data": function ( d ) {
