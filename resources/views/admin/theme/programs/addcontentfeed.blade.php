...
@section('content')
	...
	<div class="row">
	    <div class="col-md-12">
	        <div class="box">
	            <div class="box-title">
	                <!-- <h3 style="color:black"><i class="fa fa-file"></i> Add <?php echo trans('admin/program.program');?></h3> -->
	                <div class="box-tool">
                    ...
                    <form class="form-horizontal form-bordered form-row-stripped" method="post">
    						...
    						<div class="form-group" id="access">
                                ...
                                <div class="col-sm-5 col-lg-5 controls">
                                    <select class="form-control" name="program_access" id="program_access" data-rule-required="true">
                                        <option <?php if(Input::old('program_access') == "general_access") echo "selected"?> value="general_access">{{trans('admin/program.general')}}</option>
							...
							<div class="col-sm-9 col-lg-10 controls">
                                <div class="col-sm-12 col-lg-6">    
                                    <div class="fileupload fileupload-new">
                                        ...
                                        <div>
                                            <button class="btn" type="button" id="selectfromdams" data-url="{{URL::to('/cp/dams?view=iframe&from=add-program&filter=image&select=radio')}}">{{trans('admin/program.select')}}</button>
                                ...
                                <div class="col-sm-12 col-lg-6">
                                    ...
                                    <div>
                                        ...
                                        <input class = 'matrics-accuracy col-sm-6 col-lg-4' type="text" name="accuracy" value="{{Input::old('accuracy')}}"></input> 
                                        <span> &nbsp;&nbsp; %</span>
                                    </div>
                                    <br>
                                    <div>
                                        <label  class="col-sm-6 col-lg-4">{{trans('admin/program.score')}}</label> 
                                        <input class="matrics-score col-sm-6 col-lg-4" type="text" name="score" value="{{Input::old('score')}}"></input> <span> &nbsp;&nbsp; %</span>
                                    </div>
                                    <br>
                                    <div>
                                        ...
                                        <div class="input-group col-sm-6 col-lg-5">
                                            ...
                                            onclick="$(this).prev().click()" class="form-control input-time" style="cursor: pointer" value="00:00" readonly="readonly">
                        ...
                        <div class="form-group last">
                            <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                               ...
                               <a href="{{URL::to('/cp/contentfeedmanagement/')}}"><button type="button" class="btn">{{trans('admin/program.cancel')}}</button></a>
                            </div>
                        </div>
                     </form>
                </div>
