                ...
                <div class="box">
                    <div class="box-title">
                        <div class="box-content">
                            <form action="{{URL::to('cp/package/save-edit-sellability')}}" class="form-horizontal form-bordered" id="subscription_tab" name="subscription_tab" method="post">
                              <!-- BEGIN Left Side -->
                              <!-- Hidden Fields -->
                              <?php //dd($subscription);?>
                             ...
                             <input type='hidden' id="slug" name="slug" value="{{$subscription['package_slug']}}">
                            <?php
...
$(document).ready(function() {
 ...
 $('#subscription_tab').on('submit', function(e){
      e.preventDefault();
       $.ajax({
                method: "POST",
                url: "<?php echo URL::to('cp/package/save-edit-sellability');?>",
                data:
                { 
