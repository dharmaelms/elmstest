                ...
                <div class="box-content">
                    ...
                    <div class="btn-toolbar pull-right clearfix">
                        <div class="btn-group">
                          ...
                          {?>
                            <div class="btn-group">
                                <a  class="btn btn-primary btn-sm"  href="{{url::to('cp/categorymanagement/add-parent')}}">
                                    <span class="btn btn-circle blue show-tooltip custom-btm">
                                        <i class="fa fa-plus"></i>
                                    </span>&nbsp;{{ trans('admin/category.add_new_category') }}
                                </a>&nbsp;&nbsp;&nbsp;
                            </div>
                            <?php }
                            if (has_admin_permission(ModuleEnum::CATEGORY, CategoryPermission::DELETE_CATEGORY)) { ?>
                        ...
                        <table class="table table-advance" id="datatable">
                            <thead>
                                <tr>
                                    ...
                                    <?php if($add_category==true || $edit_category==true || $delete_category==true) {?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                                ...
                                <div class="box">
                                    <div class="box-title">
                                        ...
                                        <h3 class="modal-header-title">
                                            <i class="icon-file"></i>
                                                {{ trans('admin/category.delete_category') }}
                                        </h3>                                                
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-body" style="padding: 20px">
                        {{ trans('admin/category.modal_delete_single_cat') }}
                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="box">
                                    <div class="box-title">
                                        ...
                                        <h3 class="modal-header-title">
                                            <i class="icon-file"></i>
                                              {{ trans('admin/category.assign_channels') }}
                                        </h3>                                                
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="bulkdeletemodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static">
            <div class="modal-dialog">
                <div class="modal-content">
                            ...
                            <div class="col-md-12">
                                <div class="box">
                                    <div class="box-title">
                                        ...
                                        <h3 class="modal-header-title">
                                            <i class="icon-file"></i>
                                                {{ trans('admin/category.delete_categories') }}
                                        </h3>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-body" style="padding: 20px">
                        {{ trans('admin/category.modal_deleted_category') }}
                    </div>
                    <div class="modal-footer">
                ...
                $(document).on('click','.bulkdeletecategory',function(e){
                    ...
                    if($.isEmptyObject(checkedBoxes)){
                        ...
                        $('#bulkdeletebtn').unbind('click').click(function(e){
                            e.preventDefault();
                            var $form = $('<form></form>').prop('action','{{URL::to('/cp/categorymanagement/bulk-delete')}}').attr('method','post');
