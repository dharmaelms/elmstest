<div class="form-group">
    ...
    <div class="col-sm-9 col-lg-6 controls">
        <input type="text" name="event_name" class="form-control" value="{{ Input::old('event_name') }}" >
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-lg-6 controls">
        <textarea name="event_description" rows="5" id="{{ $editor }}" class="form-control ckeditor">{!! Input::old('event_description') !!}</textarea>
